...
export function Input({
  ...
  return (
    <input
      className={cn(
        "w-full rounded-xl border border-[var(--color-border)] bg-black/30 px-4 py-2.5 text-sm text-white placeholder:text-[var(--color-muted)] outline-none transition focus:border-[var(--color-primary)] focus:ring-2 focus:ring-indigo-500/20",
        className
      )}
      {...props}
    />
